// # Завдання 5
// Створіть функцію personInfo, яка приймає об'єкт 
// в якості параметра та виконує деструктуризацію цього об'єкта, 
// витягуючи з нього наступні поля: "name", "age", "email", "city". 
// Потім використайте деструктуризовані значення для створення нового 
// об'єкта з наступними полями: 
